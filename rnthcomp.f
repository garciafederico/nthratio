      SUBROUTINE rnthcomp(Ear,Ne,Param,Ifl,Photar,Photer)
      implicit none
      INTEGER Ne , Ifl
...
c     6: Energy in keV at which the model is unity
      ...
      INTEGER n , ierr, np
      REAL xninv , normfac , normlum, SPP, pa0(5), EnergyNormkeV
...
c  calculate internal source spectrum if input parameters have changed
     ...
     >           xth,nth,spt)
         ...
         xninv = 511.0/zfactor/EnergyNormkeV
         normfac = EnergyNormkeV**2/SPP(xninv,xth,nth,spt)
...
c  input parameters:
      ...
      real    ear(0:5000),photar(5000),photer(5000), parth(10)
      integer ifl,ne
